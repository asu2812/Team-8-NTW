...
function CheckAP(){
    var adminAccount='nhom8@gmail.com';
    var adminPass='nhom8123';

    var clientAcc = 'long@gmail.com';
    var clientPass = 'long1234';

    var clientacc = 'hoang@gmail.com';
    var clientpass = 'hoang123'; 
    ...
    if(input0==''||input1==''){
        ...
        location.href = "C:/Users/asu28/Desktop/Nhóm 8/quản trị/admin.html";
    }else if(input0==clientAcc&&input1==clientPass){
        alert('Đăng Nhập Thành Công.');
        localStorage.setItem("name", input0)
        location.href = "C:/Users/asu28/Desktop/Nhóm 8/TrangChu1.html";
    }else if(input0==clientacc&&input1==clientpass){
        alert('Đăng Nhập Thành Công.');
        localStorage.setItem("name", input0)
        location.href = "C:/Users/asu28/Desktop/Nhóm 8/TrangChu1.html";
